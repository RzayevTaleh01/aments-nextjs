...
const imageGallery = {
	...
	`,
	buttonClass: "",
	add: async function (core) {
		await core.addModule([dialog]);
	...
	setDialog: function () {
        ...
        <div class="se-dialog-footer">
			<button onclick="" class="customBtn applyBtn mb-10 r100 mr-3 applyBtn-ministry">
				<span>File Manager</span>
			</button>
			<button type="button" data-command="close" class="customBtn applyBtn applyBtn-light mb-10 r100 mr-3">
