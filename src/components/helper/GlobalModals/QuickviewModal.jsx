...
export default function QuickviewModal() {
  ...
  return (
    <Modal id="modalQuickview" isOpen={isOpen} toggle={close} centered modalClassName="fade">
      <ModalBody>
            ...
            <div className="col-md-6">
              <div className="product-details-content-area">
                <div className="product-details-text">
                  <h4 className="title">{product?.name ?? "Nonstick Dishwasher PFOA"}</h4>
                  <div className="price">
                    {product?.compareAt ? <del>{product.compareAt}</del> : <del>$70.00</del>}
                    {product?.price ?? "$80.00"}
                  </div>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia iste laborum ad impedit pariatur esse optio tempora sint ullam autem
                    deleniti nam in quos qui nemo ipsum numquam, reiciendis maiores quidem aperiam, rerum vel recusandae
                  </p>
                </div>
