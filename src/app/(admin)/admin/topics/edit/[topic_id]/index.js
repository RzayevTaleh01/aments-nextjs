...
export default function Index() {
    ...
    function handleSubmit(e) {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            // ApiService.put(`${LANGUAGE_EDIT_ROUTE}/${topic_id}`, data).then(resp => {
            //     router.push({
            //         pathname: '/content/idareedici/languages/'
    ...
    useEffect(() => {
        // ApiService.get(`${LANGUAGE_SHOW_ROUTE}/${topic_id}`).then(resp => {
    ...
    return (
        <>
            <SgPage>
                <SgPageHead
                    header='Mövzular'
                    description='Mövzunun redaktəsi.'
                    filter={true}
                >
                    <SgButton
                        type='link'
