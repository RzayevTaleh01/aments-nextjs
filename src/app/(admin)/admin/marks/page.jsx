...
import { DELETE_MARK_BY_ID_ROUTE, GET_MARKS_ROUTE } from "@/admin/configs/apiRoutes";
...
export default function Page() {
  ...
  function toEditUrl(id) {
    ...
    const base = `/admin/marks/edit/${id}`;
  ...
  function handleDeleteConfirmed() {
    ...
    ApiService.delete(`${DELETE_MARK_BY_ID_ROUTE}/${id}`)
      .then(() => {
    ...
    <MainLayout>
      <SgPage>
        ...
        <SgPageBody>
          ...
          <SgPopup
            header="Markanı sil"
            description={`Bu markanı silmək istəyirsiniz? (ID: ${selectedRow?.id ?? "-"})`}
