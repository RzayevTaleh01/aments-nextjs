    ...
    <MainLayout>
      <SgPage>
        <SgPageHead header="Brendlər" description="Brendlərin siyahısı." filter={true}>
          <SgButton type="link" to="/admin/brands/create" color="primary" size="md" icon="plus">
            Əlavə et
          </SgButton>
        </SgPageHead>
        <SgPageBody>
                ...
                },
                {
                  ...
                  cell: (row) => (
                    <SgButtonGroup gap={true}>
                      <SgButton type="link" to={`/admin/brands/edit/${row?.id}`} size="sm" color="secondary-outline" icon="pen" onlyIcon={true} minimal={true} />
