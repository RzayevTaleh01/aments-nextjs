                                        ...
                                        return (
                                            <>
                                                <SgButton
                                                    ...
                                                    type='link'
                                                    to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${row?.subject_id}/pupil/0`}
                                                >
                                                    {key}
                                                </SgButton>
                                            </>
                                        ...
                                        return (
                                            <>
                                                <SgButton
                                                    ...
                                                    color='primary-outline'
                                                    type='link'
                                                    to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${row?.subject_id}/pupil/1`}
                                                >
                                                    {key}
                                                </SgButton>
                                            </>
                                        ...
                                        return (
                                            <>
                                                <SgButton
                                                    ...
                                                    color='primary-outline'
                                                    type='link'
                                                    to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${row?.subject_id}/pupil/2`}
                                                >
                                                    {key}
                                                </SgButton>
                                            </>
                                        ...
                                        return (
                                            <>
                                                <SgButton
                                                    ...
                                                    color='primary-outline'
                                                    type='link'
                                                    to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${row?.subject_id}/pupil/3`}
                                                >
                                                    {key}
                                                </SgButton>
                                            </>
                                        ...
                                        return (
                                            <>
                                                <SgButton
                                                    ...
                                                    color='primary-outline'
                                                    type='link'
                                                    to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${row?.subject_id}/pupil/4`}
                                                >
                                                    {key}
                                                </SgButton>
                                            </>
                                        ...
                                        return (
                                            <>
                                                <SgButton
                                                    ...
                                                    color='primary-outline'
                                                    type='link'
                                                    to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${row?.subject_id}/pupil/5`}
                                                >
                                                    {key}
                                                </SgButton>
                                            </>
                                            ...
                                            <>
                                                <SgButtonGroup>
                                                    <SgButton
                                                        ...
                                                        color='primary'
                                                        type='link'
                                                        to={`/content/idareedici/progress-statistics/${region_id}/${school_id}/${grade_id}/${key}`}
                                                    >
                                                        Göstəricilər
                                                    </SgButton>
                                                </SgButtonGroup>
