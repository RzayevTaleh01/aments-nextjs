...
export default function Index() {
    ...
    function handleSubmit(e) {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            ApiService.put(`${EDIT_FAQ_BY_ID_ROUTE}/${faq_id}`, {...data}).then(async () => {
                await router.push({
    ...
    useEffect(() => {
        ApiService.get(`${GET_FAQ_BY_ID_ROUTE}/${faq_id}`).then(resp => {
