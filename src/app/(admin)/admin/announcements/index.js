...
import {
    DELETE_ANNOUNCEMENT_BY_ID_ROUTE,
    GET_ANNOUNCEMENTS_ROUTE,
...
export default function Index() {
    ...
    function handleRemoveItem() {
        ApiService.delete(`${DELETE_ANNOUNCEMENT_BY_ID_ROUTE}/${selectedRow.id}`).then(() => {
            ...
            <SgPage>
                ...
                >
                    <SgButton
                        type='link'
                        isLinked={true}
                        to='/content/idareedici/announcements/create'
                        color='primary'
                        size='md'
                        icon='plus'
                    >
                                            ...
                                            <>
                                                <SgButtonGroup>
                                                    <SgButton
                                                        ...
                                                        color='primary'
                                                        type='link'
                                                        to={`/content/idareedici/announcements/edit/${key}`}
                                                    >
                                                        Düzəliş et
                                                    </SgButton>
                                                    <SgButton
