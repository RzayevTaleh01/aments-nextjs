...
import {
    DELETE_SCHOOL_SURVEY_ROUTE,
    GET_INFO_BY_REGION_ID_ROUTE, GET_INFO_BY_SCHOOL_ID_ROUTE, GET_SCHOOL_SURVEY_ROUTE,
                                            ...
                                            <>
                                                <SgButtonGroup>
                                                    <SgButton
                                                        ...
                                                        color='primary'
                                                        type='link'
                                                        to={`/content/idareedici/statistics/${region_id}/survey/${school_id}/questions/${key}`}
                                                    >
                                                        Suallar
                                                    </SgButton>
                                                </SgButtonGroup>
